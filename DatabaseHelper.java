...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    //7.1 same--------------------------------------------database ইনপুট  addIncome method
...
//8 ============================================Expense টাকা table যুক্ত করছি।টোটাল টাকা দেখানোর জন্য select from দিয়ে পুরা expense টেবিল ধরছি নিচে loop দিয়ে যোগ করছি
...
//8.1 same============================================ইনকাম টাকা যে যুক্ত করছি সেটা টোটাল টাকা দেখানোর জন্য
...
//============================================
    ...
    //9\\\\\\\\\\\\\\\\\\\\Expense show করার জন্য showAllExpense method create করছি । Database table থাকা data cursor হিসেবে return করবে
    ...
    //9.1\\\\\\\\\\\\\\\\\\\\Income show করার জন্য showAllIncome method create করছি । Database table থাকা data cursor হিসেবে return করবে
    ...
    //10  ddddddddddddddddddddddddddddddddddddddddddddddddddddddddd table থেকে data delete করার জন্য
    ...
    //10.1  ddddddddddddddddddddddddddddddddddddddddddddddddddddddddd  table থেকে data delete করার জন্য
